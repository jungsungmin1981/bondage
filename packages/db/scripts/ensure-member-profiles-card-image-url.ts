/**
 * member_profiles 테이블에 card_image_url 컬럼이 없으면 추가.
 * "column card_image_url does not exist" 발생 시 실행:
 *   pnpm --filter @workspace/db run db:ensure-member-profiles-card-image-url
 */
