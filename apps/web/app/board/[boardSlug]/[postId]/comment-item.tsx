...
import {
  createSharedBoardCommentAction,
  updateSharedBoardCommentAction,
  deleteSharedBoardCommentAction,
...
export function BoardCommentItem({
  ...
  async function handleDelete() {
    ...
    const result = await deleteSharedBoardCommentAction(comment.id);
    if (result.ok) {
      onSuccess();
      router.refresh();
    } else {
